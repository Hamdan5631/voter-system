...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('role:superadmin|team_lead')->group(function () {
        ...
        Route::delete('wards/{ward}/revert', [WardController::class, 'revertClonedWard'])->name('api.wards.revert');
    });
    ...
    Route::prefix('voters')->group(function () {
        ...
        Route::get('/find-voter', [VoterController::class, 'findVoter'])->name('api.voters.find-voter');
